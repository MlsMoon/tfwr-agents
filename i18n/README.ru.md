...
- `setup.bat` / `setup.ps1` — сначала язык, потом путь к сейву; копирует репозиторий и сам заканчивает init
- `i18n/` — переводы README и тексты установки. Корень репозитория остаётся на английском
...
`setup.bat` сначала спросит **язык** (`en`, `zh-CN`, `ru`, …), потом путь к сейву, **скопирует репозиторий туда и сам закончит init**. Вторая команда не нужна.
