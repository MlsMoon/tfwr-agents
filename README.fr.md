...
1. trouve le dossier userdata (ou `-GameRoot`)
2. y copie `AGENTS.md` et `.agents\skills` (ignoré si vous y êtes déjà)
3. copie `templates\Save0\*.py` vers `Saves\Save0` — **n’écrit jamais `save.json`**
4. crée :
